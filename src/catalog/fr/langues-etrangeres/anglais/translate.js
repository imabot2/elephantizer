...
const translations = {
  ...
  en: {
    ...
    verbesIrregulier: 'Irregular verbs in French',
    verbesIrregulierShort: 'Irregular verbs',
  ...
  fr: {
    ...
    verbesIrregulier: 'Les verbes irréguliers',
    verbesIrregulierShort: 'Verbes irréguliers',
